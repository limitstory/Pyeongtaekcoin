Pyeongtaekcoin Core version *0.15.1* is now available from:

  <https://download.pyeongtaekcoin.org/pyeongtaekcoin-0.15.1/>
...
A number of changes to the way Pyeongtaekcoin Core deals with peer connections and invalid blocks
