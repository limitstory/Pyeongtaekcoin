...
PYEONGTAEKCOIND=${BITCOIND:-$BINDIR/pyeongtaekcoind}
PYEONGTAEKCOINCLI=${BITCOINCLI:-$BINDIR/pyeongtaekcoin-cli}
PYEONGTAEKCOINTX=${BITCOINTX:-$BINDIR/pyeongtaekcoin-tx}
PYEONGTAEKCOINQT=${BITCOINQT:-$BINDIR/qt/pyeongtaekcoin-qt}
