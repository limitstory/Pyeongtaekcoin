...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " pyeongtaekcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  pyeongtaekcoin-tx [options] <hex-tx> [commands]  Update hex-encoded pyeongtaekcoin transaction\n" +
            "or:     pyeongtaekcoin-tx [options] -create [commands]   Create hex-encoded pyeongtaekcoin transaction\n" +
            "\n";
