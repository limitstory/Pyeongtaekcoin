...
"""Verify that starting pyeongtaekcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pyeongtaekcoin with -h for help text")
        ...
        self.log.info("Start pyeongtaekcoin with -version for version information")
        ...
        self.log.info("Start pyeongtaekcoind with -fakearg to make sure it does not start")
