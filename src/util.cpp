...
const char * const BITCOIN_CONF_FILENAME = "pyeongtaekcoin.conf";
const char * const BITCOIN_PID_FILENAME = "pyeongtaekcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Pyeongtaekcoin";
#else
    // Unix
