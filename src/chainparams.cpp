...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.pyeongtaekcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.pyeongtaekcointools.com");
        vSeeds.emplace_back("dnsseed.pyeongtaekcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.pyeongtaekcointools.com");
        vSeeds.emplace_back("seed-b.pyeongtaekcoin.loshan.co.uk");
