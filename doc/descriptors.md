# Support for Output Descriptors in Pyeongtaekcoin Core

Since Pyeongtaekcoin Core v0.17, there is support for Output Descriptors in the
...
on Pyeongtaekcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Pyeongtaekcoin Core wallets, a convenience function `combo` is
